...
const CACHE_NAME = 'habit-tracker-v2.9.9';
...
const ASSETS = [
  ...
  './back-trap.js?v=2.9.9',
  './keypad.js?v=2.9.9',
  './emoji-utils.js?v=2.9.9',
  './data-manager.js?v=2.9.9',
  './file-backup.js?v=2.9.9',
  './calendar-view.js?v=2.9.9',
  './habits-view.js?v=2.9.9',
  './day-sheet.js?v=2.9.9',
  './habit-manager.js?v=2.9.9',
  './intro.js?v=2.9.9',
  // Slide one of the explainer, in both themes
  './example-month.png?v=2.9.9',
  './example-month-dark.png?v=2.9.9',
  './example-gear.png?v=2.9.9',
  './example-gear-dark.png?v=2.9.9',
  './look-manager.js?v=2.9.9',
  './theme-manager.js?v=2.9.9',
  './import-export-manager.js?v=2.9.9',
  './script.js?v=2.9.9'
];
