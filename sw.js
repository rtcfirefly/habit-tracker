...
const ASSETS = [
  ...
  './emoji-utils.js?v=2.1.0',
  './data-manager.js?v=2.1.0',
  './file-backup.js?v=2.1.0',
  './calendar-view.js?v=2.1.0',
  './habits-view.js?v=2.1.0',
  './day-sheet.js?v=2.1.0',
  './habit-manager.js?v=2.1.0',
  './intro.js?v=2.1.0',
  // Slide one of the explainer, in both themes
  './example-month.png?v=2.1.0',
  './example-month-dark.png?v=2.1.0',
  './example-gear.png?v=2.1.0',
  './example-gear-dark.png?v=2.1.0',
  './theme-manager.js?v=2.1.0',
  './import-export-manager.js?v=2.1.0',
  './script.js?v=2.1.0'
];
