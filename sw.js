...
const CACHE_NAME = 'habit-tracker-v1.3.1';
...
const ASSETS = [
  ...
  './emoji-utils.js?v=1.3.1',
  './data-manager.js?v=1.3.1',
  './file-backup.js?v=1.3.1',
  './calendar-view.js?v=1.3.1',
  './habits-view.js?v=1.3.1',
  './habit-manager.js?v=1.3.1',
  './theme-manager.js?v=1.3.1',
  './import-export-manager.js?v=1.3.1',
  './script.js?v=1.3.1'
];
