...
const CACHE_NAME = 'habit-tracker-v2.9.7';
...
const ASSETS = [
  ...
  './back-trap.js?v=2.9.7',
  './keypad.js?v=2.9.7',
  './emoji-utils.js?v=2.9.7',
  './data-manager.js?v=2.9.7',
  './file-backup.js?v=2.9.7',
  './calendar-view.js?v=2.9.7',
  './habits-view.js?v=2.9.7',
  './day-sheet.js?v=2.9.7',
  './habit-manager.js?v=2.9.7',
  './intro.js?v=2.9.7',
  // Slide one of the explainer, in both themes
  './example-month.png?v=2.9.7',
  './example-month-dark.png?v=2.9.7',
  './example-gear.png?v=2.9.7',
  './example-gear-dark.png?v=2.9.7',
  './look-manager.js?v=2.9.7',
  './theme-manager.js?v=2.9.7',
  './import-export-manager.js?v=2.9.7',
  './script.js?v=2.9.7'
];
