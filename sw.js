...
const CACHE_NAME = 'habit-tracker-v1.3.0';
...
const ASSETS = [
  ...
  './emoji-utils.js?v=1.3.0',
  './data-manager.js?v=1.3.0',
  './file-backup.js?v=1.3.0',
  './calendar-view.js?v=1.3.0',
  './habits-view.js?v=1.3.0',
  './habit-manager.js?v=1.3.0',
  './theme-manager.js?v=1.3.0',
  './import-export-manager.js?v=1.3.0',
  './script.js?v=1.3.0'
];
