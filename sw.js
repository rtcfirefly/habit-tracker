...
const CACHE_NAME = 'habit-tracker-v1.13.2';
...
const ASSETS = [
  ...
  './emoji-utils.js?v=1.13.2',
  './data-manager.js?v=1.13.2',
  './file-backup.js?v=1.13.2',
  './calendar-view.js?v=1.13.2',
  './habits-view.js?v=1.13.2',
  './habit-manager.js?v=1.13.2',
  './intro.js?v=1.13.2',
  // Slide one of the explainer, in both themes
  './example-month.png?v=1.13.2',
  './example-month-dark.png?v=1.13.2',
  './example-gear.png?v=1.13.2',
  './example-gear-dark.png?v=1.13.2',
  './theme-manager.js?v=1.13.2',
  './import-export-manager.js?v=1.13.2',
  './script.js?v=1.13.2'
];
