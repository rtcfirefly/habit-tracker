...
const CACHE_NAME = 'habit-tracker-v2.9.4';
...
const ASSETS = [
  ...
  './back-trap.js?v=2.9.4',
  './keypad.js?v=2.9.4',
  './emoji-utils.js?v=2.9.4',
  './data-manager.js?v=2.9.4',
  './file-backup.js?v=2.9.4',
  './calendar-view.js?v=2.9.4',
  './habits-view.js?v=2.9.4',
  './day-sheet.js?v=2.9.4',
  './habit-manager.js?v=2.9.4',
  './intro.js?v=2.9.4',
  // Slide one of the explainer, in both themes
  './example-month.png?v=2.9.4',
  './example-month-dark.png?v=2.9.4',
  './example-gear.png?v=2.9.4',
  './example-gear-dark.png?v=2.9.4',
  './look-manager.js?v=2.9.4',
  './theme-manager.js?v=2.9.4',
  './import-export-manager.js?v=2.9.4',
  './script.js?v=2.9.4'
];
