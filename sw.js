...
const CACHE_NAME = 'habit-tracker-v1.18.3';
...
const ASSETS = [
  ...
  './emoji-utils.js?v=1.18.3',
  './data-manager.js?v=1.18.3',
  './file-backup.js?v=1.18.3',
  './calendar-view.js?v=1.18.3',
  './habits-view.js?v=1.18.3',
  './habit-manager.js?v=1.18.3',
  './intro.js?v=1.18.3',
  // Slide one of the explainer, in both themes
  './example-month.png?v=1.18.3',
  './example-month-dark.png?v=1.18.3',
  './example-gear.png?v=1.18.3',
  './example-gear-dark.png?v=1.18.3',
  './theme-manager.js?v=1.18.3',
  './import-export-manager.js?v=1.18.3',
  './script.js?v=1.18.3'
];
