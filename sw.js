...
const CACHE_NAME = 'habit-tracker-v2.9.8';
...
const ASSETS = [
  ...
  './back-trap.js?v=2.9.8',
  './keypad.js?v=2.9.8',
  './emoji-utils.js?v=2.9.8',
  './data-manager.js?v=2.9.8',
  './file-backup.js?v=2.9.8',
  './calendar-view.js?v=2.9.8',
  './habits-view.js?v=2.9.8',
  './day-sheet.js?v=2.9.8',
  './habit-manager.js?v=2.9.8',
  './intro.js?v=2.9.8',
  // Slide one of the explainer, in both themes
  './example-month.png?v=2.9.8',
  './example-month-dark.png?v=2.9.8',
  './example-gear.png?v=2.9.8',
  './example-gear-dark.png?v=2.9.8',
  './look-manager.js?v=2.9.8',
  './theme-manager.js?v=2.9.8',
  './import-export-manager.js?v=2.9.8',
  './script.js?v=2.9.8'
];
