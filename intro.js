...
const SLIDES = [
  {
    ...
    artClass: 'is-shot',
    art: `<img class="intro-pic intro-pic-light" src="example-month.png?v=2.6.3"
               alt="The calendar with habit icons on most days, above the habit buttons" width="390" height="560">
          <img class="intro-pic intro-pic-dark" src="example-month-dark.png?v=2.6.3"
               alt="The calendar with habit icons on most days, above the habit buttons" width="390" height="560">`,
  ...
  },
  {
    ...
    artClass: 'is-strip',
    art: `<img class="intro-pic intro-pic-light" src="example-gear.png?v=2.6.3"
               alt="The Manage Habits button in the top right of the header" width="390" height="64">
          <img class="intro-pic intro-pic-dark" src="example-gear-dark.png?v=2.6.3"
               alt="The Manage Habits button in the top right of the header" width="390" height="64">`,
